...
Understand the directory structure: `.ai/DIRECTORY_MAP.md`
...
2. **Session Initialization**:
   - At the start of EACH new session/context (when counter resets to 0/3), you MUST read these files ONCE in this order:
     ...
     c) /.ai/fixes - Known issues and fixes
...
- Check /.ai/fixes for any known issues related to the feature area
