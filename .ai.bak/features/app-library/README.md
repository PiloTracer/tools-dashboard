...
|----------|---------|----------|
| Auto-Auth Integration Guide | How to integrate external apps | `.ai/features/auto-auth/guide-app-library.md` |
| Auto-Auth Specification | OAuth 2.0 server specification | `.ai/features/auto-auth.md` |

### Session Starters

| Document | Purpose | Location |
|----------|---------|----------|
| App Library Starter | Quick start prompt for Claude Code sessions | `.ai/prompts/app-library-starter.md` |

### Seed Data

| File | Purpose | Location |
|------|---------|----------|
| E-Cards Seed Data | Initial application data | `.ai/features/app-library/ecards-seed-data.sql` |
...
Please read:
1. DOCS_CONTEXT.md
2. .ai/features/app-library/README.md
3. .ai/features/app-library/IMPLEMENTATION_PLAN.md

Confirm you understand and are ready to proceed.
```

**Full session starter:** [.ai/prompts/app-library-starter.md](../../prompts/app-library-starter.md)
