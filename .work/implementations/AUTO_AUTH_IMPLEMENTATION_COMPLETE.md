...
### 1. Documentation
- `.work/features/auto-auth.md` - **RE-WRITTEN** from correct perspective
- `.work/implementations/AUTO_AUTH_IMPLEMENTATION_COMPLETE.md` - This summary
...
1. **Feature Specification:** `.work/features/auto-auth.md`
2. **Database Schemas:**
   - PostgreSQL: `back-postgres/schema/006_oauth_tables.sql`
   - Cassandra: `back-cassandra/schema/004_oauth_auth_events.cql`
3. **API Documentation:**
...
3. **Implement OAuth Flow:**
   - See example code in `.work/features/auto-auth.md`
