...
**Documentation Updates:**
- Update `DOCS_CONTEXT.md`
- Update service DOCS_CONTEXT.md files
- Create user guide
- Create admin guide
...
- `.work/features/app-library/USER_GUIDE.md`
- `.work/features/app-library/ADMIN_GUIDE.md`
- `.work/implementations/FEATURE_app-library_2025-11-15.md`
...
- `.work/features/app-library/USER_GUIDE.md`
- `.work/features/app-library/ADMIN_GUIDE.md`
- `.work/prompts/app-library-starter.md`
- `.work/implementations/FEATURE_app-library_2025-11-15.md`
