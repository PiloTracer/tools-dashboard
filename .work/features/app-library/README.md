...
|----------|---------|----------|
| Auto-Auth Integration Guide | How to integrate external apps | `.work/features/auto-auth/guide-app-library.md` |
| Auto-Auth Specification | OAuth 2.0 server specification | `.work/features/auto-auth.md` |

### Session Starters

| Document | Purpose | Location |
|----------|---------|----------|
| App Library Starter | Quick start prompt for Claude Code sessions | `.work/prompts/app-library-starter.md` |

### Seed Data

| File | Purpose | Location |
|------|---------|----------|
| E-Cards Seed Data | Initial application data | `.work/features/app-library/ecards-seed-data.sql` |
...
Please read:
1. DOCS_CONTEXT.md
2. .work/features/app-library/README.md
3. .work/features/app-library/IMPLEMENTATION_PLAN.md

Confirm you understand and are ready to proceed.
```

**Full session starter:** [.work/prompts/app-library-starter.md](../../prompts/app-library-starter.md)
...
1. **Auto-Auth Feature** ✅
   ...
   - PKCE implementation
   - See: `.work/features/auto-auth.md`
