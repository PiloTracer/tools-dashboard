...
# .work/claude directories

Understand the directory structure: `.work/DIRECTORY_MAP.md`
...
2. **Session Initialization**:
   - At the start of EACH new session/context (when counter resets to 0/3), you MUST read these files ONCE in this order:
     ...
     c) /.work/fixes - Known issues and fixes
...
- Check /.work/fixes for any known issues related to the feature area
