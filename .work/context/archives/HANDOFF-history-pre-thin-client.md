# Archived handoff (pre thin-client cleanup)

**Archived:** 2026-07-25 · **Superseded by:** `.work/context/HANDOFF.md` · Secrets redacted.
...
| `POSTGRES_PASSWORD` | `[REDACTED]` | `[REDACTED]` | ✅ Synced |
| `JWT_SECRET_KEY` | `[REDACTED]` | `[REDACTED]` | ✅ Synced |
| `OAUTH_CONSENT_SERVICE_SECRET` | `[REDACTED]` | `[REDACTED]` | ✅ Synced |
| `DEFAULT_ADMIN_PASSWORD` | `[REDACTED]` | `[REDACTED]` | ✅ Synced |
| `SEAWEED_S3_ACCESS_KEY` | `[REDACTED]` | `[REDACTED]` | ✅ Synced |
| `SEAWEED_S3_SECRET_KEY` | `[REDACTED]` | `[REDACTED]` | ✅ Synced |
| `GOOGLE_OAUTH_CLIENT_ID` | `[REDACTED]` | *(empty — set for prod)* | ❌ Must set per-environment |
| `GOOGLE_OAUTH_CLIENT_SECRET` | `[REDACTED]` | *(empty — set for prod)* | ❌ Must set per-environment |
