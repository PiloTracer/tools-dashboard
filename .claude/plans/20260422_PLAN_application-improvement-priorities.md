...
**Plan file:** `.claude/plans/20260422_PLAN_application-improvement-priorities.md`  
...
- [ ] Open `.claude/plans/20260422_PLAN_application-improvement-priorities.md` (this file).  
