...
|-----------|---------|-------------|
| `client_id` | `ecards_a1b2c3d4` | Your OAuth client ID |
...
**Example URL:**
```
http://localhost:7300/?client_id=ecards_a1b2c3d4&redirect_uri=http%3A%2F%2Flocalhost%3A7300%2Fauth%2Fcallback&scope=profile+email+subscription&state=40ed89e34402fb08436e5692e8568e23d372442916638a77b65e99bc4930bca4&response_type=code
```
...
3. You should be redirected to your app with OAuth parameters:
   ```
   http://localhost:7300/?client_id=ecards_a1b2c3d4&state=...&code_challenge=...
   ```
...
Redirecting to: http://epicdev.com/oauth/authorize?client_id=ecards_a1b2c3d4&state=...
```
