...
export async function action({ request }: ActionFunctionArgs) {
  ...
  try {
    ...
    if (grantType === "authorization_code") {
      ...
      // Note: code_verifier is OPTIONAL for pre-initiated OAuth flows from App Library
      // For pre-initiated flows, PKCE is not used, and client_secret provides authentication
